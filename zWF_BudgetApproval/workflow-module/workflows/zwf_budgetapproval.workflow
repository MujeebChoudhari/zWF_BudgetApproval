{
	"contents": {
		"79f9cfbf-dc05-4afa-91f0-96896001d686": {
			...
			"id": "zwfbudgetapproval.zwf_budgetapproval",
			"subject": "zwf_budgetapproval",
			"name": "zwf_budgetapproval",
			"documentation": "Budget Approval Workflow for GB P2P",
		...
		"5b1d7b5a-384d-40cd-b143-10c2233c260b": {
			...
			"userInterface": "sapui5://html5apps/gb.wf.cer.budget.approve",
		...
		"7fb679c8-57ab-4793-861b-93ad2a35fa2f": {
			...
			"reference": "/scripts/zwf_budgetapproval/setWFParameters.js",
			"id": "scripttask1",
			"name": "Set WF Parametrs",
		...
		"d40e0e21-8a79-4c30-af72-6175a065d474": {
			...
			"points": "-207,75.49999940395355 -59,75.49999940395355",
