	...
	"contents": {
		"79f9cfbf-dc05-4afa-91f0-96896001d686": {
			...
			"activities": {
				...
				"836fd158-6b7f-436d-86be-753f93c87dc6": {
					"name": "Mail Approver"
				},
				"5e1adff7-51d1-4508-8285-ff967cbb6930": {
					"name": "Comfirmation Mail to Requestor"
				},
			...
			"sequenceFlows": {
				...
				"8885d074-a0e4-4139-9531-8cb7391498f5": {
					"name": "SequenceFlow10"
				},
				"8fda6f14-2ec9-4605-81d7-637f71361714": {
					"name": "SequenceFlow11"
				},
		...
		"5b1d7b5a-384d-40cd-b143-10c2233c260b": {
			...
			"userInterface": "sapui5://html5apps/cerbudgetapprove/gb.wf.cer.budget.approve",
		...
		"7fb679c8-57ab-4793-861b-93ad2a35fa2f": {
			...
			"reference": "/scripts/ZGB_ApproveBudget/setWFParameters.js",
			"id": "scripttask1",
			"name": "Set WF Parametrs",
		...
		"836fd158-6b7f-436d-86be-753f93c87dc6": {
			...
			"id": "mailtask2",
			"name": "Mail Approver",
			"mailDefinitionRef": "aa379b0d-8a23-4db8-a808-d2e798e4b674"
		},
		"5e1adff7-51d1-4508-8285-ff967cbb6930": {
			"classDefinition": "com.sap.bpm.wfs.MailTask",
			"destinationSource": "consumer",
			"id": "mailtask3",
			"name": "Comfirmation Mail to Requestor",
			"mailDefinitionRef": "46617201-1908-418b-87cf-86a075511add"
		},
		"302cf5b3-4a51-41ce-8eea-82543ac82945": {
			"classDefinition": "com.sap.bpm.wfs.MailTask",
			"destinationSource": "consumer",
		...
		"4326dc16-2639-4065-b045-a40f620fd00b": {
			...
			"targetRef": "5e1adff7-51d1-4508-8285-ff967cbb6930"
		},
		"670c22e2-3185-4501-8476-d98da4de74fe": {
			"classDefinition": "com.sap.bpm.wfs.SequenceFlow",
			"id": "sequenceflow2",
		...
		"503d27d3-8ac5-4953-8ada-e0427ab68ff0": {
			...
			"targetRef": "836fd158-6b7f-436d-86be-753f93c87dc6"
		},
		"8885d074-a0e4-4139-9531-8cb7391498f5": {
			"classDefinition": "com.sap.bpm.wfs.SequenceFlow",
			"id": "sequenceflow10",
			"name": "SequenceFlow10",
			"sourceRef": "836fd158-6b7f-436d-86be-753f93c87dc6",
		...
		"8fda6f14-2ec9-4605-81d7-637f71361714": {
			...
			"id": "sequenceflow11",
			"name": "SequenceFlow11",
			"sourceRef": "5e1adff7-51d1-4508-8285-ff967cbb6930",
			"targetRef": "9965cfd4-6339-45c2-b8f6-9b36aac0859a"
		},
		"90c1d537-18ce-48cd-b1f4-afcd6463724e": {
			"classDefinition": "com.sap.bpm.wfs.SequenceFlow",
		...
		"617e9400-51c3-4878-a1aa-3cc04cedecdc": {
			...
			"symbols": {
				...
				"509036ce-91eb-4d99-b325-c955a909a390": {},
				"0da0db4d-2060-4792-b82f-e95e8e80893e": {},
				"b158f05a-0526-4b54-8515-6616bff7e877": {},
				"1a2526e0-9d99-4a0b-8ea7-dd8e7ee71c4d": {},
		...
		"d40e0e21-8a79-4c30-af72-6175a065d474": {
			...
			"points": "-285,74.49999970197678 -174,74.49999970197678",
			"sourceSymbol": "5b8ca97b-ad06-4828-9271-c5e050e95a3d",
			"targetSymbol": "b158f05a-0526-4b54-8515-6616bff7e877",
		...
		"c195eade-4845-4f0b-808b-fae57665df02": {
			...
			"targetSymbol": "509036ce-91eb-4d99-b325-c955a909a390",
		...
		"509036ce-91eb-4d99-b325-c955a909a390": {
			...
			"width": 100,
			"height": 60,
			"object": "836fd158-6b7f-436d-86be-753f93c87dc6"
		},
		"0da0db4d-2060-4792-b82f-e95e8e80893e": {
			"classDefinition": "com.sap.bpm.wfs.ui.SequenceFlowSymbol",
			"points": "155,76 282.9999988079071,75.99999940395355",
			"sourceSymbol": "509036ce-91eb-4d99-b325-c955a909a390",
			"targetSymbol": "b0670394-86a3-4f6c-b3e4-7d69730358b0",
			"object": "8885d074-a0e4-4139-9531-8cb7391498f5"
		},
		"b158f05a-0526-4b54-8515-6616bff7e877": {
			"classDefinition": "com.sap.bpm.wfs.ui.MailTaskSymbol",
			"x": -224,
			...
			"width": 100,
			"height": 60,
			"object": "5e1adff7-51d1-4508-8285-ff967cbb6930"
		},
		"1a2526e0-9d99-4a0b-8ea7-dd8e7ee71c4d": {
			"classDefinition": "com.sap.bpm.wfs.ui.SequenceFlowSymbol",
			"points": "-174,76.99999970197678 -59,76.99999970197678",
			"sourceSymbol": "b158f05a-0526-4b54-8515-6616bff7e877",
			"targetSymbol": "bcd30679-f2a6-459c-afdc-4ed77de4260d",
			"object": "8fda6f14-2ec9-4605-81d7-637f71361714"
		},
		"581fbe3d-96e9-41d9-9dab-aabfb81e5d54": {
			"classDefinition": "com.sap.bpm.wfs.ui.MailTaskSymbol",
			"x": 155,
		...
		"aa379b0d-8a23-4db8-a808-d2e798e4b674": {
			"classDefinition": "com.sap.bpm.wfs.MailDefinition",
			"name": "maildefinition2",
			"to": "${context.nextApprover}",
			"subject": "[P2P] Budget request - Approve",
			"text": "Dear ${context.nextApproverName},\n\nYou received a Budget request to approve, please check your WF inbox.\n\nTitle: ${context.ShortText}\nRequester: ${context.requesterFirstName} ${context.requesterSecondName}\nLegal entity: ${context.legalEntity} - ${context.legalEntityDisplayName}\nCost center: ${context.costCenter} - ${context.costCenterDisplayName}\nType: ${context.typeDisplayText} \nInternal Order: ${context.internalOrder} - ${context.internalOrderDisplayName}\nAmount requested: ${context.requestedAmountFormatted} ${context.oStatusData.Zcurr}\n\nComment:\n${context.sCommentHistory}\n\nAttachments: ${context.sAttachementUrls}\n\nLink to your Inbox: https://flpnwc-tw72h2gxnz.dispatcher.eu2.hana.ondemand.com/",
			"ignoreInvalidRecipients": true,
			"id": "maildefinition2"
		},
		"46617201-1908-418b-87cf-86a075511add": {
			"classDefinition": "com.sap.bpm.wfs.MailDefinition",
			"name": "maildefinition3",
			"to": "${context.requesterEmail}",
			"subject": "[P2P] Budget request - Submitted",
			"text": "Dear ${context.requesterFirstName} ${context.requesterSecondName},\n\nYou have successfully submitted a Budget request to approve.\n\nTitle: ${context.ShortText}\nRequester: ${context.requesterFirstName} ${context.requesterSecondName}\nLegal entity: ${context.legalEntity} - ${context.legalEntityDisplayName}\nCost center: ${context.costCenter} - ${context.costCenterDisplayName}\nType: ${context.typeDisplayText} \nInternal Order: ${context.internalOrder} - ${context.internalOrderDisplayName}\nAmount requested: ${context.requestedAmountFormatted} ${context.oStatusData.Zcurr}\n\nComment:\n${context.sCommentHistory}\n\nAttachments: ${context.sAttachementUrls}\n\nLink to P2P: https://flpnwc-tw72h2gxnz.dispatcher.eu2.hana.ondemand.com/\n",
			"id": "maildefinition3"
		},
