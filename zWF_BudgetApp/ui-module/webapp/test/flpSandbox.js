		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zbudgetappuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zbudgetappuimodule-display": {
								"semanticObject": "zbudgetappuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zbudgetapp.uimodule",
									"url": sap.ui.require.toUrl("zbudgetapp/uimodule")
								}
							}
						}
					}
