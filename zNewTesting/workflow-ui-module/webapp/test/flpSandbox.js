		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BGDAPP",
									"targetURL": "#testingworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testingworkflowuimodule-display": {
								"semanticObject": "testingworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=testing.workflowuimodule",
									"url": sap.ui.require.toUrl("testing/workflowuimodule")
								}
							}
						}
					}
